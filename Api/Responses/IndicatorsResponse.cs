...
public class DesiredFinancialMetricsDto
{
  ...
  {
    DesiredIncome = efficiency != null
      ? Math.Round(efficiency.DesiredEarnings, 2)
      : null;
    DesiredProfit = efficiency != null
      ? Math.Round(efficiency.DesiredProfit, 2)
      : null;
    DesiredProfitability = efficiency != null
      ? Math.Round(efficiency.DesiredProfitability, 2)
      : null;
  }
}
...
public class ReserveFinanceDto
{
  ...
  {
    ReserveForQuarter = efficiency != null
      ? Math.Round(efficiency.ReserveForQuarter, 2)
      : null;
    ReserveForHalfYear = efficiency != null
      ? Math.Round(efficiency.ReserveForHalfYear, 2)
      : null;
    ReserveForYear = efficiency != null
      ? Math.Round(efficiency.ReserveForYear, 2)
      : null;
  }
}
