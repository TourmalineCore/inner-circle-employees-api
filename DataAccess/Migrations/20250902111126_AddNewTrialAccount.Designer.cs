...
namespace SalaryService.DataAccess.Migrations
{
    ...
    [Migration("20250902111126_AddNewTrialAccount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.CoefficientOptions", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.EstimatedFinancialEfficiency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.TotalFinances", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.TotalFinancesHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Employee", b =>
                {
                    b.OwnsOne("Core.EmployeeFinancialMetrics", "FinancialMetrics", b1 =>
                        {
            ...
            modelBuilder.Entity("Core.EmployeeFinancialMetricsHistory", b =>
                {
                    ...
                    b.OwnsOne("Core.Common.Period", "Period", b1 =>
                        {
