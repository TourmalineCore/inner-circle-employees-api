...
public class EmployeeDbContext : DbContext
{
  ...
  {
    modelBuilder
      .Entity<EmployeeFinancialMetricsHistory>()
      .OwnsOne(history => history.Period,
        navigationBuilder =>
        {
          navigationBuilder
            .Property(history => history.FromUtc)
            .HasColumnName("FromUtc");
          navigationBuilder
            .Property(history => history.ToUtc)
            .HasColumnName("ToUtc");
        });

    modelBuilder
      .Entity<TotalFinancesHistory>()
      .OwnsOne(history => history.Period,
        navigationBuilder =>
        {
          navigationBuilder
