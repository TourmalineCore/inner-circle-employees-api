...
public static class MetricsDiffCalculator
{
  public static EmployeeFinancialMetricsDiff CalculateDiffBetweenEmployeeFinancialMetrics(EmployeeFinancialMetrics sourceMetrics, EmployeeFinancialMetrics newMetrics)
  {
    return new EmployeeFinancialMetricsDiff
    {
      ...
      SocialInsuranceContributions = newMetrics.SocialInsuranceContributions - sourceMetrics.SocialInsuranceContributions,
  ...
  public static TotalEmployeeFinancialMetricsEntry CalculateTotalEmployeeFinancialMetrics(IEnumerable<EmployeeFinancialMetrics> metrics)
  {
  ...
  public static EmployeeFinancialTotalMetricsDiff CalculateDiffBetweenTotalEmployeeFinancialMetrics(
    TotalEmployeeFinancialMetricsEntry sourceTotalMetrics,
    TotalEmployeeFinancialMetricsEntry newTotalMetrics
  )
  {
